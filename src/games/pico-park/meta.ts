...
const meta: GameMeta = {
  id: 'pico-park',
  title: { en: 'Two Together', nl: 'Two Together' },
  preferredOrientation: 'landscape',
  description: {
    en: 'Co-op platformer for two. Neither player can finish alone — work together to open doors and boost each other up.',
    nl: 'Coöperatieve platformer voor twee. Geen van beiden kan alleen finishen — werk samen om deuren te openen en elkaar omhoog te helpen.',
  },
  minPlayers: 2,
  maxPlayers: 2,
  rules: {
